  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <small>Zum Datenschutz: Piraten und Clientdaten werden nach <?php echo intdiv(MAXTIME, 60); ?> Minuten Inaktivität gelöscht.
        Wenn die Tabelle Clients dann leer ist, werden auch die Einstellungen zurückgesetzt.</small>
      </div>
